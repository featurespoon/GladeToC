...
gchar *signal_param_names[][10] =
  {
    ...
    { "GtkCellRendererText","editing-started","GtkCellEditable *","gchar *"},
    { "GtkCellRenderer","editing-started","GtkCellEditable *","gchar *"},
    { "GtkCellRendererAccel","accel-edited","gchar*","gint","GdkModifierType","guint"},
    { "GtkCellRendererAccel","accel-cleared","gchar*"},
    { "GtkTreeView","row-activated","GtkTreePath*","GtkTreeViewColumn*"},
    { "GtkTreeView","row-collapsed","GtkTreeIter*","GtkTreePath*"},
    { "GtkTreeView","row-expanded","GtkTreeIter*","GtkTreePath*"},
    { "GtkTreeModel","row-changed","GtkTreePath*","GtkTreeIter*"},
    { "GtkTreeModel","row-deleted","GtkTreePath*"},
    { "GtkTreeModel","row-inserted","GtkTreePath*","GtkTreeIter*"},
    { "GtkTreeModel","has-child-toggled","GtkTreePath*","GtkTreeIter*"},
    { "GtkModelButton","clicked"},
    { "GtkEntry","delete-from-cursor","GtkDeleteType","gint"},
    { "GtkEntry","insert-at-cursor","gchar*"},
